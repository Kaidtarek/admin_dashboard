...
RouteBase get $homeGateRoute => GoRouteData.$route(
      path: '/',
      factory: _$HomeGateRoute._fromState,
    );

mixin _$HomeGateRoute on GoRouteData {
  static HomeGateRoute _fromState(GoRouterState state) => const HomeGateRoute();
